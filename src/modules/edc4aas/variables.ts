...
export const CONNECTOR_SELF_DESCRIPTION_API = new InjectionToken<string>('HOME_CONNECTOR_SELF_DESCRIPTION_API');
export const CONNECTOR_DEFAULT_API = new InjectionToken<string>('HOME_CONNECTOR_DEFAULT_API');
